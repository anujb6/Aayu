...
export function createCompleteBlob(creature, x, y, baseSize, px, frame = 0) {
  const STAGE_SIZES = { 1: 0.5, 2: 0.65, 3: 0.65, 4: 0.65, 5: 0.65, 6: 0.65 }
  const sizeMultiplier = STAGE_SIZES[creature.stage] || 0.65
...
export function createStageFeatures(stage, x, y, size, color, frame, px) {
  ...
  // Only blush marks at stage 2+, no other stage features
  if (stage >= 2) {
