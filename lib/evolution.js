 ...
 * @returns {object} { canEvolve: bool, xpMet: bool, daysMet: bool, xpNeeded: num, daysNeeded: num }
 */
 ...
 * Records history, increments stage, resets stage XP
 * @param {object} creature - Creature object
...
export function getDaysProgress(creature) {
  ...
  return Math.min(100, Math.round((creature.daysInStage / minDays) * 100))
}
